  ...
  validates :nome_grupo, :nome_usuario, presence: false
    ...
    def validar_hora
      if(self.status == "Deferido")
        ...
        x.cargahoraria_total[18] = (x.cargahoraria_total[0] + x.cargahoraria_total[1] + x.cargahoraria_total[2] + x.cargahoraria_total[3] + x.cargahoraria_total[4] + x.cargahoraria_total[5] + x.cargahoraria_total[6] + x.cargahoraria_total[7] + x.cargahoraria_total[8] + x.cargahoraria_total[9] + x.cargahoraria_total[10] + x.cargahoraria_total[11] + x.cargahoraria_total[12] + x.cargahoraria_total[13] + x.cargahoraria_total[14] + x.cargahoraria_total[15] + x.cargahoraria_total[16] + x.cargahoraria_total[17])
        x.cargahoraria[18] = (x.cargahoraria[0] + x.cargahoraria[1] + x.cargahoraria[2] + x.cargahoraria[3] + x.cargahoraria[4] + x.cargahoraria[5] + x.cargahoraria[6] + x.cargahoraria[7] + x.cargahoraria[8] + x.cargahoraria[9] + x.cargahoraria[10] + x.cargahoraria[11] + x.cargahoraria[12] + x.cargahoraria[13] + x.cargahoraria[14] + x.cargahoraria[15] + x.cargahoraria[16] + x.cargahoraria[17])
